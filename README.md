...
* A patch to call cracklib in order to check for the password strenght. This should avoid unsafe accounts created by domain administrators such as "test 123456". This enhanses the original patch by Inter7.
...
The patchs applyed can by found in the contrib directory.
